...
import com.lyon.easy.common.struct.ringbuffer.ConcurrentRingBuffer;
 ...
 * @author Lyon
 */
public class ConcurrentRingBufferTestUseCase {

    @Test
    public void testRingBuffer() {
        ConcurrentRingBuffer<Integer> ringBuffer = new ConcurrentRingBuffer<>(10);
